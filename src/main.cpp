...
uint256 hashGenesisBlock("0x00000689e1ead5e2273b463229b0ff1a657800dc67423a76e7cc121fa573ec09");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // WEIGRATE: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "WEIGRATE Signed Message:\n";
...
{
    // WEIGRATE: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // WEIGRATE: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        // vMerkleTree: 9b91fb601ca8c1fa5f6d68f9f783e47c35a041df5519767c9bb65e52b9f6bd27 
...
\
		...
		const char* pszTimestamp = "weigrate genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1498155769;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1777046;
        ...
        assert(block.hashMerkleRoot == uint256("0x9b91fb601ca8c1fa5f6d68f9f783e47c35a041df5519767c9bb65e52b9f6bd27"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc8, 0xb4, 0xda }; // WEIGRATE: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WEIGRATEMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WEIGRATEMiner : ProcessBlock, block not accepted");
    }
