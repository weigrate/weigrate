...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "WEIGRATE " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"95.85.18.143", "95.85.18.143"},
	{"95.85.8.50", "95.85.8.50"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. WEIGRATE is probably already running."), addrBind.ToString().c_str());
        else
